...
for (let i = 19; i < 27; i++) squares[i].classList.add('c1'); // Example cars
for (let i = 28; i < 36; i++) squares[i].classList.add('l1'); // Example logs
for (let i = 37; i < 45; i++) squares[i].classList.add('l4'); // Example river
